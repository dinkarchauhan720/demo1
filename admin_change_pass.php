...
<div class="signup-form" >
    <form style="background: #031219bf;" onkeyup="return validationpass()" onsubmit="return validationpass()" name="myform" action="update_change_password.php" method="post">
         ...
         <div class="form-group">
			<div class="row">
				<div class="col">
					...
					<input type="hidden"  id="id" name="u_id" value="<?php echo $row['id']; ?>">
